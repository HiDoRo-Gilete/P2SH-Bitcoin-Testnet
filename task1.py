...
explorer.get_utxos(my_address) # determine the txid and output index
...
# Step 3: Create a transaction output to the desired destination
# TODO: Update destination_address
destination_address = P2WPKHBitcoinAddress("tb1qg6m8u3shyrgf6xz0wtq92jvxqpzdc9dh9sc2l3")
# TODO: Update amount_to_send
total = 29853
...
txid = explorer.broadcast_testnet_transaction_blockstream(tx)
if txid != None:
